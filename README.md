...
| **Prompt(s) utilizados** | 1) "Vc pode me ajudar em um trabalho? Eu quero que vc faça o README que o arquivo pede. Eu vou te enviar a entrevista que eu fiz com a empresa e vc me fala as informações que vc precisa pra fazer o README." 2) Envio do PDF da entrevista de campo feita na clínica, com o pedido: "essa é a entrevista, se vc precisar de mais alguma informação me avisa." 3) "Meu professor falou pra gente adicionar o link do dicionário de dados no README, eu vi que vc fez ele direto no README, vc pode colocar o link dele lá?" — pedindo para substituir o dicionário completo por um link para um arquivo HTML separado. 4) Envio de foto da visita à clínica, do endereço completo, telefone e link do Google Maps, pedindo um modelo de texto para a seção de evidências da organização. |
